...
<CardContainer id="contact-us">
	<header class="card-header my-6 text-center text-5xl font-heading-token">Contact Us</header>

	<div class="m-3 flex flex-col items-center justify-center gap-4 text-justify md:m-4">
		<p class="unstyled my-10 md:my-24">
			Located accross Belleview Elementary School, Belleview UMC sponsors and hosts the Holy Rollers
			BJJ Club. <br />
		</p>
		<div
		...
		>
			...
			<div class="h-full w-full">
				...
				<p
					class="unstyled flex h-full w-full flex-col items-center text-primary-500 hover:text-primary-600"
				>
